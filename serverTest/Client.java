...
public class Client implements Runnable {
    ...
    public List<AboutMessage> getMessages() {
        List<AboutMessage> list = new ArrayList<AboutMessage>();
        ...
        try {
            ...
            for (Object o : jsonArray) {
            	AboutMessage mes = AboutMessage.parseInfoMessage((JSONObject)o);
    ...
    public void sendMessage(AboutMessage message) {
        HttpURLConnection connection = null;
        try {
            connection = getHttpURLConnection();
    ...
    public void listen() {
        while (true) {
            List<AboutMessage> list = getMessages();
    ...
    public void run() {
        ...
        while (true) {
        	AboutMessage message = new AboutMessage(scanner.nextLine(),userName);
            sendMessage(message);
        }
    }
}
